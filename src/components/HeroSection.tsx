        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.h1
              variants={fadeInUp}
              transition={{ duration: 0.5 }}
              className="text-[clamp(2.25rem,4.8vw,4rem)] font-extrabold text-white leading-[1.08] mb-6 tracking-tight"
            >
            ...
            >
              {services.map((s) => (
                <span
                  key={s.label}
                  className="inline-flex items-center gap-1.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white/80 hover:text-white text-[clamp(0.75rem,0.9vw,0.825rem)] font-semibold px-3.5 py-2 rounded-xl transition-all duration-300 cursor-pointer shadow-sm"
                >
